...
public final class DomainEventType {
    ...
    public static final String CLAIM_CANDIDATE_RECORDED = "hzb.kno.claim-candidate-recorded.v1";

    /** Address of the controlledActionRequested channel. */
    public static final String CONTROLLED_ACTION_REQUESTED = "hzb.kno.controlled-action-requested.v1";
