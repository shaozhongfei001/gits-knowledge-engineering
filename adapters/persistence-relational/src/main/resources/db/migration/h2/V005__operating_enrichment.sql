-- V005: Operating enrichment tables (H2 compatible)
...
CREATE TABLE IF NOT EXISTS relationship_report (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP,
    CONSTRAINT fk_rel_report_case FOREIGN KEY (operating_case_id) REFERENCES operating_case(case_id),
    CONSTRAINT fk_rel_report_supersedes FOREIGN KEY (supersedes_report_id) REFERENCES relationship_report(report_id),
